	...
	return (
		<div>
			<div className="relative group">
				<div className="bg-black h-[300px]  md:h-[500px] opacity-90 w-full top-0 right-0 left-0 bottom-0 my-10 overflow-hidden">
					...
					<img
						...
						className="block h-[300px] md:h-[500px] object-cover overflow-hidden group-hover:scale-[1.1]  transition duration-300 ease-in-out"
					/>
				</div>
			</div>
