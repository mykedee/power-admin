				...
				<div className="w-11/12 md:w-9/12 mx-auto my-20">
					...
					<form className="md:mx-3" onSubmit={handleSubmit}>
						...
						<div className="mx-3 mb-4">
							<label className="block mb-1 text-sm font-semibold text-slate-500">Email</label>
							<input
								className="p-3 border rounded w-full"
								type="email"
								value={email}
						...
						<div className="mx-3 mb-4">
							...
							<div className="relative flex items-center justify-between border-gray-500 rounded w-full outline outline-1 outline-offset-2 focus:border-gray-500 focus:outline focus:outline-1 focus:outline-offset-2">
								<input
