...
const DialogBox = ({ handleSubmit, setOpen, dialogLabel, dialogInfo, buttonLabel }) => {
	...
	return (
		<div className="fixed top-0 bottom-0 left-0 right-0 z-50 bg-[rgba(0,0,0,0.5)] w-full max-h-full overflow-y-scroll">
			<div className="relative mb-28  w-11/12 lg:w-3/12 top-24 bottom-0 mx-auto max-w-2xl max-h-full">
